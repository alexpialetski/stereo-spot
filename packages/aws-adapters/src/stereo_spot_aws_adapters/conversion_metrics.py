"""AWS CloudWatch conversion metrics.
Emits StereoSpot/Conversion (segment size buckets: 0-5, 5-20, 20-50, 50+ MB)."""
...
class CloudWatchConversionMetricsEmitter:
    """ConversionMetricsEmitter that sends metrics to AWS CloudWatch."""
