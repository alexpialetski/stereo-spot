...
| `inference_ec2_ami_id` | When `inference_backend=http` and Terraform creates EC2: AMI for the GPU instance. Empty = latest AWS Deep Learning OSS Nvidia Driver GPU AMI (same family as SageMaker) | (empty) |
